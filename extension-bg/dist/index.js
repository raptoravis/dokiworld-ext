...
// src/index.js
var SETTINGS_KEY = "background-settings.v1";
var LEGACY_STORAGE_KEY = "dokiworld.extension.background-customizer.settings.v1";
...
var closeActiveSettingsDialog = null;
var managedBackgrounds = /* @__PURE__ */ new Map();
...
function openSettingsDialog(context, initial, onSave, trigger) {
  ...
  const closeButton = button("\xD7", "button");
...
function createSettingsPanel(context, initial, onSave) {
  ...
  form.append(...fields.map((field2) => field2.label), actions, status);
...
async function loadSettings(context) {
  try {
    ...
    if (stored !== void 0) return normalizeSettings(stored);
